...
// public class FileMirrorSync {
    ...
    // private static void main2(String[] args) throws Exception {
        ...
        // fsp.main(sourcePath, targetPath, options, ui, statistics, false);
    ...
    // private static String formatDiffs(long[] diffs) {
        // return "added: " + diffs[FileSyncProcessor.DiffStatus.add.ordinal()] + ", " +
        // "modified: " + diffs[FileSyncProcessor.DiffStatus.modify.ordinal()] + ", " +
        // "renamed: " + diffs[FileSyncProcessor.DiffStatus.rename.ordinal()] + ", " +
        // "deleted: " + diffs[FileSyncProcessor.DiffStatus.delete.ordinal()];
    // }
    ...
    // private static void parseCommandLineArgs(String[] args) {
        ...
        // while (!clp.eol()) {
            // if (clp.isSwitch())
                // processSwitch(clp);
            // else
                // processPositionalParameter(clp);
        // }
    ...
    // private static void processSwitch(CommandLineParser clp) {
        // if (clp.check("-h") || clp.check("-help") || clp.check("-?") || clp.check("?") || clp.check("/?") || clp.check("help")) {
            // displayHelpOption = true;
        ...
        // } else {
            // throw new CommandLineParser.CommandLineException("Unrecognized command-line option \"" + clp.getToken() + "\".");
        // }
    // }
    ...
    // private static void displayHelp() {
        ...
        // System.out.println("\n" +
            ...
            // "    Default is " + (defaultOptions.ignoreCase ? "-ignoreCase" : "-noIgnoreCase") + ".\n\n" +
            // " -renameCase\n" +
            // " -noRenameCase\n" +
            ...
            // "    Default is " + (defaultOptions.renameCase ? "-renameCase" : "-noRenameCase") + ".\n\n" +
            ...
            // "    Default is " + defaultOptions.timeTolerance + ".\n\n" +
            // " -summerTimeTolerance\n" +
            ...
            // "    Default is " + (defaultOptions.summerTimeTolerance ? "-summerTimeTolerance" : "-noSummerTimeTolerance") + ".\n\n" +
            ...
            // "    Default is " + (defaultOptions.ignoreSystemHiddenFiles ? "-ignoreSystemHiddenFiles" : "noIgnoreSystemHiddenFiles") + ".\n\n" +
            // " -v <verbosityLevel>\n" +
            // " -verbosity <verbosityLevel>\n" +
            // "    Verbosity level between 0 and 9.\n" +
            // "    Default is " + defaultOptions.verbosityLevel + "\n\n" +
            // " -debugLevel <debugLevel>\n" +
            // "    Debug level between 0 and 9.\n" +
            // "    Default is " + defaultOptions.debugLevel + ".\n\n" +

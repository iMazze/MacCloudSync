...
public final class CommandLineParser {
    ...
    public String nextArg() {
        if (isSwitch()) throw new CommandLineException("Option \"" + getToken() + "\" encountered when expecting argument.");
        return nextToken();
    }
    ...
    public float nextArgFloat() {
        ...
        try {
            ...
            throw new CommandLineException("Invalid floating point number command line parameter value \"" + s + "\".");
        }
    }
    ...
    public < T extends Enum < T >> T nextArgEnum(Class < T > enumType) {
        ...
        try {
            ...
            throw new CommandLineException("Invalid enumeration command line parameter value \"" + s + "\".");
        }
    }
